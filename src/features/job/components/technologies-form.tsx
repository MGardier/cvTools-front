...
export const TechnologiesForm =({t,form, technologiesFields}: TechnologiesFormProps)=> {
  const [techBadges,setTechBadges] = useState<{name: string}[]>([]) ;
  return (
              <div className="grid gap-6">
                {/** TECHNOLOGIES  */}
                <FormCardField
                  label={t("pages.createJob.form.technologies.label")}
                  name="jobTitle"
                  type="text"
                    ...
                    {techBadges.map((tech, index) => (
                      <Badge
                        ...
                        onClick={() => {
                          ...
                          setTechBadges((prevState)=> prevState.filter((prevTech)=> prevTech !== tech))
                          }} 
                      >
                        ...
                        <FormItem>
                          <FormControl>
                            ...
                            onClick={()=> {
                              ...
                              setTechBadges((prevState)=> [...prevState,{name: form.watch(`technologies.${index}.name`)}])
                            }}
                              type="button"
